...
public class TestOptimizer {
    ...
    public void threeOptswap(){
        optimizer.tempArray = new Place[8];
        Place place0 = new Place();
        place0.id = "0";
        optimizer.tempArray[0] = place0;
        Place place1 = new Place();
        place1.id = "1";
        optimizer.tempArray[1] = place1;
        Place place2 = new Place();
        place2.id = "2";
        optimizer.tempArray[2] = place2;
        Place place3 = new Place();
        place3.id = "3";
        optimizer.tempArray[3] = place3;
        Place place4 = new Place();
        place4.id = "4";
        optimizer.tempArray[4] = place4;
        Place place5 = new Place();
        place5.id = "5";
        optimizer.tempArray[5] = place5;
        Place place6 = new Place();
        place6.id = "6";
        optimizer.tempArray[6] = place6;
        Place place7 = new Place();
        place7.id = "0";
        optimizer.tempArray[7] = place7;

        optimizer.threeOptTempArray = optimizer.tempArray;

        optimizer.ThreeOptExchange(1,3,6);
